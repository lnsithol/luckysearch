...
class Luckysearch(object):
    ...
    Typical usage::
        ...
        ls = luckysearch.Luckysearch('/tmp/luckysearch')
        ls.index('email_1', {'text': "This is a blob of text to be indexed."})
        ls.search('blob')
    ...
    def __init__(self, base_directory):
        ...
        Example::
            ...
            ls = luckysearch.Luckysearch('/var/my_index')
    ...
    def read_stats(self):
        ...
        version of ``luckysearch`` & zero docs (used in scoring).
        """
    ...
    def collect_results(self, terms):
        ...
        Since this is complex, an example return value::
            ...
            >>> per_term_docs, per_doc_counts = ls.collect_results(['hello', 'world'])
            >>> per_term_docs
            {
                'hello': 2,
                'world': 1
